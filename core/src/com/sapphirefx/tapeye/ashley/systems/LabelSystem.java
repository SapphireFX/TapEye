...
public class LabelSystem extends IteratingSystem
{
    ...
    protected void processEntity(Entity entity, float deltaTime)
    {
        ...
        labelComponent.layout.setText(font, labelComponent.text, 0, labelComponent.text.length, Color.WHITE, dimensionsComponent.width,
                labelComponent.lineAlign, labelComponent.wrap, null);
